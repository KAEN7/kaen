	...
	return (
		<OverviewSection mobile={isMobile}>
			...
			<div className="content">
				...
				<ul>
					<li>
						저는 React와 AWS를 사용해 서비스 배포 및 운영을 경험한 프론트엔드
						개발자입니다.
					</li>
					<li>
						사이드 프로젝트와 대회에서는 항상 디자인적인 요소나 새로운 기술을
						도전해보는 것을 좋아합니다. 이를 통해 빠르게 습득하고 적용하는
						능력을 키웠습니다.
					</li>
					<li>
						더불어, 특정 사용자를 위해 업무를 자동화시키고 효과적인 디자인을
						제공할 수 있는 것에 매력을 느껴 개발을 시작하게 되었습니다. 그리고
